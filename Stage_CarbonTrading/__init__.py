...
class TradingMarket(Page):
    ...
    def market_state(player: Player) -> Dict[str, Any]:
        ...
        try:
            ...
            display_buy_orders = filter_top_buy_orders_for_display(buy_orders, max_per_quantity=3)
            display_sell_orders = filter_top_sell_orders_for_display(sell_orders, max_per_quantity=3)
